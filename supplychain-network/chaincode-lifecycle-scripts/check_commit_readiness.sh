...
peer lifecycle chaincode checkcommitreadiness -o localhost:7050 --channelID supplychain-channel --tls --cafile $ORDERER_CA --name supplychain --version 1.0 --sequence 1 --output json --init-required
