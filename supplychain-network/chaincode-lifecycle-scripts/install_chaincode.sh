...
print Green "========== Installing Chaincode on peer $orgName =========="
peer lifecycle chaincode install supplychain.tar.gz --peerAddresses localhost:$PORT --tlsRootCertFiles $CORE_PEER_TLS_ROOTCERT_FILE